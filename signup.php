                ...
                <div class="form-content">
                    <div class="heist-logo animated pulse delay-1s infinite">
                        ...
                        <div class="heist-form">
                            <form action="signup.php" method="POST" name="form" onsubmit="return formValidation()">
                                ...
                                <input type="text" name="phone" class="form-control" id="mobile" placeholder="Mobile Number eg 09012345678" required aria-required="true">
